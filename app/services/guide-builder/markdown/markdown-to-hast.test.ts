...
test("generate html from markdown", async () => {
  const html = await markdownToHast(testMd);
  expect(html).toMatchSnapshot();
});

// test("case youtube", async () => {
// 	const html = await markdownToHast(
// 		"::youtube[Video of a cat in a box]{#01ab2cd3efg}",
// 	);

// 	expect(html.value.toString()).toMatchSnapshot();
// });

// test("case button", async () => {
// 	const html = await markdownToHast(
// 		"::button[Go To Home!]{ path=/path/to/home }",
// 	);
